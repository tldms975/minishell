...
void	ft_expander_table(t_fuc *funct)
{
    ...
    (funct->function)[EX_DOLLAR][EX_NORMAL] = NULL;
    (funct->function)[EX_DOLLAR][EX_SI_QUO] = NULL;
    (funct->function)[EX_DOLLAR][EX_DO_QUO] = NULL;
    (funct->function)[EX_DOLLAR][EX_DOLLAR] = NULL;
}